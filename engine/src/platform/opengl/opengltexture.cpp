...
namespace Elysium
{
	namespace Util
	{
		static uint32_t CreateTexture(uint32_t width,
									  uint32_t height,
		...
		: m_Path(imgFile)
	{
		...
		m_Id = Util::CreateTexture(width, height, (GLenum)m_InternalFormat, (GLenum)m_DataFormat, data);
		...
		: m_Width(width), m_Height(height)
	{
		...
		m_Id = Util::CreateTexture(width, height, (GLenum)m_InternalFormat, (GLenum)m_DataFormat, nullptr);
	}
