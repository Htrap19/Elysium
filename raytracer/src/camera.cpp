...
void Camera::OnUpdate(Elysium::Timestep ts)
{
    ...
    {
        m_Position += m_ForwardDirection * speed * ts.GetSeconds();
        moved = true;
    }
    ...
    {
        m_Position += rightDirection * speed * ts.GetSeconds();
        moved = true;
    }
    ...
    if (Elysium::Input::IsKeyPressed(Elysium::Key::E))
    {
        m_Position += upDirection * speed * ts.GetSeconds();
        moved = true;
    }

    if (Elysium::Input::IsKeyPressed(Elysium::Key::Q))
    {
        m_Position -= upDirection * speed * ts.GetSeconds();
        moved = true;
    }
